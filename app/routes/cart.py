...
def view_cart():
    ...
    items = []
    subtotal = 0
    total_productos = 0  # ✅ Nuevo campo: cantidad total de productos
    ...
    for pid, qty in cart.items():
        ...
        if product:
            ...
            subtotal += line_total
            total_productos += qty  # ✅ Suma de todas las cantidades
            items.append({
                "product": product,
                "qty": qty,
    ...
    return render_template(
        ...
        items=items,
        subtotal=subtotal,
        total_productos=total_productos  # ✅ Pasamos al template
    )
